...
\begin{lema}[\cite{Lyndon_Schupp_2015}[str.~8, trditev 2.6]]
\label{lem_uporaba_nielsen}
Vsaka končnogenerirana podgrupa proste grupe je prosta.   
\end{lema}
\begin{skica}
    TODO, tu je treba le približno opisati postopek
...
\end{equation*}  
kjer je $\operatorname{ker} \psi = \operatorname{im} \varphi$, $\varphi$ je injektivni in $\psi$ surjektivni homomorfizem.
\end{definicija}
