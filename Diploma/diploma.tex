...
% TODO namesto tega dokaza napiši svoj dokaz in povej, zakoj je boljši
...
\noindent
    ...
    Po razmisleku iz prejšnje leme te podmnožice tvorijo pokritje $G$. Z uporabo komutatorske leme (TOOO tu se moraš slikati na svojo obliko !!), je netrivialni zakon v grupi $G$ oblike \begin{equation*}
    ...
    l(w) = 4(p + q) \le 8q. 
    \end{equation*}
    Pred uporabo komutatoske leme moramo navesti še dva rezultata.
    \begin{lema}
    ...
    \end{equation*}  
    ki je zakon za vse grupe $\operatorname{PSL}_2(q)$, moči $n$ ali manj. Ta rezultat ni najboljši in je predstavljal oviro, kot je omenjeno v tretjem odstavku \cite[str.~6]{Bradford_Thom_2017}.
