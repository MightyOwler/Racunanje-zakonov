...
% To lemo sem v praktično enaki obliki uspel dokazati na bolj elementaten način v obliki leme \ref{lem_komutatorska_lema_splosna}, brez uporabe Nielsenovega izreka. % TODO katerega 
...
\begin{align*}
    ...
    \left[ F_2 : K(A_5, 2) \right] &= 2^{48} \cdot  3^{24} \cdot 5^{24} = 4738381338321616896000000000000000000000000.
\end{align*}
...
Kot smo videli v prejšnjem poglavju, moramo do problema pristopiti bolj zvito. 
